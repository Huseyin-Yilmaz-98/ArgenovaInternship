                    ...
                    foreach ($entries as $entry) { ?>
                        <div class="w-100 shadow-box p-3 mb-5">
                            <div class="position-relative w-100">
                                ...
                                <a href="/<?=title_to_url($entry[6])?>"><img class="w-100 h-auto" src="/images/Blog/<?= $entry[1] ?>" style="border-radius: 16px;"></a>

                            </div>
                            <div class="p-3">
                                <a href="/<?=title_to_url($entry[6])?>" class="fw-bold text-dark fs-3"><?= $entry[6] ?></a>
                                ...
                                <a href="/<?=title_to_url($entry[6])?>" class="text-primary fw-bold">Continue Reading <i class="fa fa-arrow-right ps-2"></i></a>
                            </div>
                        </div>
                    <?php  } ?>
