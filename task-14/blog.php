                    ...
                    foreach ($entries as $entry) { ?>
                        <div class="w-100 shadow-box p-3 mb-5">
                            <div class="position-relative w-100">
                                ...
                                <a href="blog-details.php"><img class="w-100 h-auto" src="images/Blog/<?= $entry[1] ?>" style="border-radius: 16px;"></a>

                            </div>
                            <div class="p-3">
                                <a href="blog-details.php" class="fw-bold text-dark fs-3"><?= $entry[6] ?></a>
                                ...
                                <p class="my-3"><?= substr($entry[1], 20) ?></p>
                    ...
                    <div class="w-100 shadow-box p-4 my-4">
                        ...
                        <div class="latest-posts-item col-12 col-lg-12 d-flex pt-3 pe-2 my-3">
                            ...
                            <div class="col-8 col-sm-8">
                                <a href="blog-details.php" class="text-dark fw-bold">Pen Source Job Report Show More Openings Fewer</a>
                                <div class="d-flex my-2" style="font-size: 0.9em;">
                        ...
                        <div class="latest-posts-item col-12 col-lg-12 d-flex pt-3 pe-2 my-3">
                            ...
                            <div class="col-1 col-sm-1"></div>
                            <div class="col-8 col-sm-8">
                                <a href="blog-details.php" class="text-dark fw-bold">Tech Products That Makes Its Easier to Stay at Home</a>
                                <div class="d-flex my-2" style="font-size: 0.9em;">
                                    <i class="fa fa-calendar-check-o text-dark fw-bold p-1 pe-2"></i>
                                    <em class="text-muted">January 21, 2020</em>
                                </div>
                        ...
                        <div class="latest-posts-item col-12 col-lg-12 d-flex pt-3 pe-2 my-3">
                            ...
                            <div class="col-1 col-sm-1"></div>
                            <div class="col-8 col-sm-8">
                                <a href="blog-details.php" class="text-dark fw-bold">Necessity May Give Us Your Best Virtual Court System</a>
                                <div class="d-flex my-2" style="font-size: 0.9em;">
                                    <i class="fa fa-calendar-check-o text-dark fw-bold p-1 pe-2"></i>
                                    <em class="text-muted">January 21, 2020</em>
                                </div>
                        ...
                        <div class="latest-posts-item col-12 col-lg-12 d-flex pt-3 pe-2 my-3">
                            ...
                            <div class="col-1 col-sm-1"></div>
                            <div class="col-8 col-sm-8">
                                <a href="blog-details.php" class="text-dark fw-bold">Servo Project Joins The Linux Foundation Fold Desco</a>
                                <div class="d-flex my-2" style="font-size: 0.9em;">
                                    <i class="fa fa-calendar-check-o text-dark fw-bold p-1 pe-2"></i>
                                    <em class="text-muted">January 21, 2020</em>
                                </div>
