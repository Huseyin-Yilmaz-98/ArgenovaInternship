...
<body>
    ...
    <div class="breadcrumbs d-flex flex-column justify-content-center align-items-center w-100">
        <h1 class="text-white fw-bold">Servo Project Joins The Linux Foundation Fold Desco</h1>
            ...
            <div class="col-11 col-sm-10 col-xxl-8 mx-auto d-flex blog-container justify-content-center py-5">
                <div class="blog-container-left px-5">
                    ...
                    <div class="d-flex my-2" style="font-size: 0.9em;">
                        ...
                        <em class="text-muted">Strategy</em>
                        <i class="fa fa-comments-o text-primary fw-bold p-1 pe-2 ps-3"></i>
                        <em class="text-muted">1</em>
                    </div>
                    <p class="my-5">We denounce with righteous indige nation and dislike men who are so beguiled and demo realized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue cannot foresee. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled data structures manages data in technology.</p>
                    <blockquote class="blockquote fst-italic bg-light p-5 fs-6 text-muted mb-3">
                        <i class="fa fa-quote-left text-primary fs-3"></i>
                        <p class="my-3 ms-2">We can easily manage if we will only take, each day, the burden appointed to it. But the load will be too heavy for us if we carry yesterday’s burden over again today, and then add the burden of the morrow before we are required to bear it.</p>
                        <figcaption class="blockquote-footer mt-3 ms-2">Robert Calibo</figcaption>
                    </blockquote>

                    <h3 class="fw-bold my-4">Digital technology on the cutting edge</h3>
                    <ul class="mx-3 mb-3">
                    ...
                    <p class="my-4">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</p>
                    <img src="images/Blog/6.jpg" class="w-100 h-auto mb-4">
                    <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur.</p>
                    <div class="py-4">
                        <h4 class="fw-bold">1 comment on “Servo Project Joins The Linux Foundation Desco”</h4>
                        <div class="row py-4">
